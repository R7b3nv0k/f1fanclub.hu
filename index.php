...
/* ==== ÉLŐ FUTAM STÁTUSZ LEKÉRÉSE ==== */
// Megnézzük, hogy fut-e éppen a szimuláció (race_id = 25)
...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Remove any potential inline styles that might interfere */
    nav a[style*="color"] {
        color: #ffffff !important;
    }
    ...
    /* Admin and Profile buttons when logged in */
    ...
    .live-banner {
      ...
      align-items: center;
      justify-content: center;
      background: linear-gradient(90deg, #b30000, #e10600, #b30000);
      color: #fff;
      text-decoration: none;
      padding: 15px 20px;
      font-size: 1.2rem;
    ...
    .live-banner:hover {
      background: linear-gradient(90deg, #e10600, #ff1a1a, #e10600);
      color: #fff;
      letter-spacing: 5px;
    }
    ...
    .race-card {
      ...
      margin: 25px 0 30px;
      border: 1px solid rgba(225, 6, 0, 0.3);
      box-shadow: 0 20px 40px rgba(0, 0, 0, 0.8), 0 0 30px rgba(225, 6, 0, 0.1);
      position: relative;
      overflow: hidden;
    }
    ...
    .highlight-session {
      background: linear-gradient(145deg, #2a1a1a 0%, #332020 100%);
      border-color: #e10600;
    }

    .main-session {
      background: linear-gradient(145deg, #331a1a 0%, #442020 100%);
      border: 2px solid #e10600;
      position: relative;
      overflow: hidden;
    }
    ...
    /* === FEATURED SECTIONS - KOMPAKT VÁLTOZAT === */
    .featured-grid {
      display: grid;
    ...
    .featured-card:hover {
      ...
      border-color: #e10600;
      box-shadow: 0 20px 30px rgba(225, 6, 0, 0.15);
    }
    ...
    <div class="container">
      ...
      <div class="featured-grid">
        ...
        <div class="featured-card">
          ...
          <a href="/f1fanclub/news/news.php" class="featured-btn">Olvasok</a>
        </div>
      </div>
    </div>
  </section>
