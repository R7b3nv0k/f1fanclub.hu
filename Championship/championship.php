...
<body>
    ...
    <header>
        ...
        <nav style="margin: 20px 0;">
            ...
            <a href="/f1fanclub/Championship/championship.php"
                style="color:#e10600; margin:0 10px; font-weight:bold;">Championship</a>
    ...
    <main class="champ-main">
        <div class="season-selector-wrapper">
            <label for="seasonSelect"
                style="color:#888; font-size:0.9rem; font-weight:700; text-transform:uppercase; letter-spacing:1px; display:block; margin-bottom:10px;">Válassz
                szezont</label>
        ...
        <div class="f1-table-wrapper">
            <table class="f1-table">
                ...
                <tbody id="drivers-body">
                    <tr>
                        <td colspan="4" style="text-align:center; padding: 40px; color:#888;">Adatok betöltése...</td>
                    </tr>
                </tbody>
            </table>
        </div>
